...
Diese Datei findet sich jeweils im Package Source Code (ZIP)
Muss aber Zeile 27-29 für Joomla angepasst werden.
*/
/*
...
/** Joomla System Less Plugin mod -- START
// dont use autoloader but require combined less.php library
...
if (!class_exists('Less_Parser')) {
  require_once dirname(__FILE__) . '/less-1.7.0.9.php/Less.php';
}
...
/**
GHSVS 2015-11-09
Bugfix: getOptions() setzt fixe Optionen.
Andererseits gibt es aber die Möglichkeit
per
$less->setOption('relativeUrls', true);
Optionen zu setzen, die aber nicht
